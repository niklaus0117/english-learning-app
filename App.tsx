...
function App() {
  ...
  // Navigation State
  const [currentView, setCurrentView] = useState<'main' | 'dailyReading' | 'courseDetail' | 'lessonPlayer'>('main');
  // Store the previous view to handle "Back" correctly
  const [previousView, setPreviousView] = useState<'main' | 'dailyReading' | 'courseDetail'>('main');
  ...
  return (
    <div className="min-h-screen bg-white max-w-md mx-auto relative shadow-2xl overflow-hidden flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden pb-[60px]">
          ...
          <>
            ...
            <main className="px-4 pt-4">
              ...
              <div className="flex gap-3 mb-8">
                  <div className="flex-1 bg-orange-50 rounded-xl p-3 flex items-center justify-between cursor-pointer active:scale-95 transition-transform">
        ...
        {(activeTab === TabName.BOOKSHELF || activeTab === TabName.VOCABULARY || activeTab === TabName.PROFILE) && (
             <div className="flex flex-col items-center justify-center h-full pt-20 text-gray-400">
                <div className="bg-gray-100 p-6 rounded-full mb-4">
                  {activeTab === TabName.BOOKSHELF && <Icons.Book size={48} />}
                  {activeTab === TabName.VOCABULARY && <Icons.BookOpen size={48} />}
                  {activeTab === TabName.PROFILE && <Icons.User size={48} />}
                </div>
      ...
      <nav className="absolute bottom-0 w-full bg-white border-t border-gray-100 flex justify-around items-center pb-safe pt-2 h-[60px] z-50">
        ...
        <NavButton 
            ...
            onClick={() => setActiveTab(TabName.BOOKSHELF)}
        />
        {/* NEW AI TAB */}
        <div className="relative -top-5">
           <button 
             onClick={() => setActiveTab(TabName.AI_CHAT)}
        ...
        <NavButton 
            ...
            onClick={() => setActiveTab(TabName.VOCABULARY)}
        />
        <NavButton 
